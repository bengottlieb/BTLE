...
- (NSAttributedString * __nonnull)stringByAppendingString:(NSString * __nonnull)string attributes:(NSDictionary * __nonnull)attributes;
@end
...
@property (nonatomic, readonly, copy) NSArray * __nonnull underlyingErrors;
@end
...
@interface NSMutableAttributedString (SWIFT_EXTENSION(SA_Swift))
- (void)appendString:(NSString * __nonnull)string attributes:(NSDictionary * __nonnull)attributes;
- (void)assignAttributes:(NSDictionary * __nonnull)attr toUniqueSubstring:(NSString * __nonnull)text;
@end
...
+ (void)setKeyedObject:(id __nullable)object forKey:(NSString * __nonnull)key;
+ (void)setKeyedString:(NSString * __nullable)string forKey:(NSString * __nonnull)key;
+ (void)setKeyedData:(NSData * __nullable)data forKey:(NSString * __nonnull)key;
@end
