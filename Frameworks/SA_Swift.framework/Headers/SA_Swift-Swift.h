...
SWIFT_CLASS("_TtC8SA_Swift23AttributedTableViewCell")
...
SWIFT_CLASS("_TtC8SA_Swift23ContainerViewController")
...
@interface NSError (SWIFT_EXTENSION(SA_Swift))
...
@interface NSParagraphStyle (SWIFT_EXTENSION(SA_Swift))
...
SWIFT_CLASS("_TtC8SA_Swift28SA_MailComposeViewController")
...
SWIFT_CLASS("_TtC8SA_Swift16SA_TableViewCell")
...
SWIFT_CLASS("_TtC8SA_Swift11SoundEffect")
...
@interface UIImageView (SWIFT_EXTENSION(SA_Swift))
