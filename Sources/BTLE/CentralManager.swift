...
//				}
	...
	let ignoredPeripheralUUIDsKey = "ignored-btle-device-uuids"
	lazy var ignoredPeripheralUUIDs: Set<String> = {
		guard let raw = UserDefaults.standard.string(forKey: self.ignoredPeripheralUUIDsKey) else { return Set<String>() }
